...
export function initPost(post) {
	...
	const numberOfLikesNode = postCardNode.querySelector(".head .left");
	const createdNode = postCardNode.querySelector(".footer .right");
	const updatedNode = postCardNode.querySelector(".footer .left");
